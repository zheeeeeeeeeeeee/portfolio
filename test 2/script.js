...
function openProject(url) {
  ...
  cover.style.transform = `scaleX(${window.innerWidth / cardPosition.width}) scaleY(${window.innerHeight / cardPosition.height}) translate3d(${(window.innerWidth / 2 - cardPosition.width / 2 - cardPosition.left) / (window.innerWidth / cardPosition.width)}px, ${(window.innerHeight / 2 - cardPosition.height / 2 - cardPosition.top) / (window.innerHeight / cardPosition.height)}px, 0px)`;
  
  // Trigger transition
  cover.style.transition = 'transform 500ms ease-in-out';
